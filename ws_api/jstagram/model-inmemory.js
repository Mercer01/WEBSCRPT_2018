...
const data = [{
        id: 1,
        title: 'I caught a little fish...',
        file: '1.png'
    },
    {
        id: 2,
        title: 'The fish I caught was this big.',
        file: '2.png'
    },
    {
        id: 3,
        title: 'The fish I caught was quite big.',
        file: '3.png'
    },
    {
        id: 4,
        title: 'I caught the biggest fish you\'ve ever seen.',
        file: '4.png'
    },
];
...
module.exports.listPictures = (title, sort) => {
    ...
    switch (sort) {
        ...
        case 'asc':
        case 'a2z':
            retval.sort(titleAsc);
            break;

            // by title z-a
        case 'desc':
        case 'z2a':
            retval.sort(titleDesc);
            break;

            // random order
        case 'random':
        case 'rnd':
            retval = randomizeArrayStart(retval, LIMIT);
            break;
        ...
        case 'new':
        default:
            retval = retval.slice(-LIMIT).reverse();
    }
